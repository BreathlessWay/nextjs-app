...
export default class MyDocument extends Document {
  render () {
    const node = <Fragment>
      ...
      {/*<script src="http://192.168.20.243:8080/target/target-script-min.js#anonymous"/>*/}
    ...
    return (
      ...
      <Head>
        ...
        {/*兼容ios的pwa相关设置*/}
        <meta name="apple-mobile-web-app-title" content="足球魔方"/>
        ...
        <link rel='stylesheet' type='text/css' href='//zqmfcdn.huanhuba.com/app_static/zqmf/css/antd-mobile.min.css'/>
